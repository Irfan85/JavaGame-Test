...
//		canvas.addMouseWheelListener(mouseInput);
	...
	private void onComponentResized(ComponentEvent e) {
		...
		// can easily see how the viewport is maintaining it's aspect ratio. It's just for demonstration purpose.
		...
		// Now, we will adjust the size of our viewport so that it respects our desired 16:9 aspect ratio. We can just fixed the view port width and make the height compatible
		// with the ratio
		int newW = vw;
	...
	// This function also does nothing in this example since we aree not moving or changing any object
