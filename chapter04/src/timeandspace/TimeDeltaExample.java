...
//		mouseInput.poll();
	...
	private void updateObjects(double deltaTime) {
		// Our angle will increase frame by at such a rate so that when 1s will be
	...
	private void render(Graphics g) {
		...
		float rw = w/2;
		float rh = h/2;
		// One end of the line will be at center (w, h). Another will be on the circumference. We have to determine the point on
		...
		// these information for conversion
